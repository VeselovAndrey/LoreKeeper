...
namespace LoreKeeper.EF6
{
    ...
    using LoreKeeper.EF6.AdvancedFeatures;
    ...
    internal class EFRepository : IEFRepository
    {
            ...
            where TEntity : class
        {
            ...
            IEnumerable<string> propertiesList = attachedEntry.CurrentValues.PropertyNames
                .Where(propertyName => !excludedProperties.Any(name => string.Equals(name, propertyName, StringComparison.Ordinal)));
