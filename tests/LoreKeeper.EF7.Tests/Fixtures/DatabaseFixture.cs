...
namespace LoreKeeper.EF7.Tests.Fixtures
{
    ...
    using LoreKeeper.EF7.Tests.DataAccess.Database;
    using LoreKeeper.EF7.Tests.DataAccess.Database.Dto;
    using LoreKeeper.EF7;
    ...
    public class DatabaseFixture : IDisposable
    {
        ...
        private static string _dataAccessAssembly = "LoreKeeper.EF7.Tests";
